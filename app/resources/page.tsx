...
export default function ResourcesPage() {
  ...
  return (
    <>
      ...
      <section className="relative -mt-16 overflow-hidden bg-[#1B2036]">
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-20 pt-32 text-center sm:px-6 sm:pb-24 sm:pt-44 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-400">
            Free tools, original BVA research, and expert analysis — built for
            disability law attorneys. No signup required.
          </p>
        </div>
      </section>
      ...
      {/* ============================================================ */}
      {/* Section 3 — Featured Insight (BentoGrid)                    */}
      {/* ============================================================ */}
              ...
              {posts.map((post, i) => (
                <FadeIn key={post.slug} delay={i * 0.1}>
                  <GlowCard className="flex h-full flex-col">
                    <span className="inline-block self-start rounded-full bg-blue-50 px-2.5 py-0.5 text-xs font-medium text-blue-700">
